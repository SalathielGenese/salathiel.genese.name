...
@Component({
  host: {'[class]': `'backdrop-blur w-full fixed py-4 z-10 flex'`},
  selector: 'nav[sg-nav]',
  template: `
      <a class="text-grey-400 bg-grey-100 origin-center -rotate-45 text-center -left-16 fixed w-48"
      ...
      <a class="lowercase sm:px-8 sm:py-4 px-4 py-2"
